...
export default function Page() {
  ...
  const condensedServices = [
    ...
    },
    {
      ...
      description: "Get cited by ChatGPT Search, Perplexity, and Google AI Overviews. Structural content and technical signals to secure machine-readable citations.",
      path: "/services/geo"
    },
    {
